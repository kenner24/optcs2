...
function NewAssetsFromExistingClientsChart() {
  const { data: newClientData } = useGetReportChartDataQuery({
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "New Assets From Existing Clients",
      },
    },
  };
  ...
  useEffect(() => {
    const newDataSet = [];
    for (const key in newClientData?.data) {
...
export default NewAssetsFromExistingClientsChart;
