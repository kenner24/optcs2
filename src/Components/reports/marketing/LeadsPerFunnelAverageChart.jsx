...
function LeadsPerFunnelAverageChart() {
  const { data: leadsPerFunnelData } = useGetReportChartDataQuery({
  ...
  useEffect(() => {
    const newDataSet = [];
    // for (const key in leadsPerFunnelData?.data) {
...
export default LeadsPerFunnelAverageChart;
