...
function StickRatioShowRateChart() {
  const { data: stickShowData } = useGetReportChartDataQuery({
  ...
  useEffect(() => {
    const newDataSet = [];
    for (const key in stickShowData?.data) {
...
export default StickRatioShowRateChart;
