...
function ApptScheduledChart() {
  const { data: apptSchedule } = useGetReportChartDataQuery({
  ...
  useEffect(() => {
    const newDataSet = [];
    for (const key in apptSchedule?.data) {
...
export default ApptScheduledChart;
